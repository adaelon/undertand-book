...
If an accepted tool call returns `automatic_build_executor_mcp_error.v2`, stop immediately and
...
Do not relabel an observed MCP error as bootstrap failure, retry the tool, or infer task completion
