...
description: technical_learning BookStructure extractor for PB7. It consumes either one structure-unit packet or one full-book stitch packet and emits strict JSON for unit_card or spine/throughlines/key_stops only.
---
...
This is not Pass1, profile-sidecar, Pass2, reader_profile, memory, or a free-form guide article. Do not emit graph nodes, graph edges, discourse items, formula semantics, reader notes, or user-private facts.
...
5. Do not output generic filler to make the structure look complete.
6. Do not rebuild a full-book summary from source text; stitch from unit cards plus long-range evidence.
