...
export const PdfSourceMapV2Z = z.object({
  ...
  formula_glyph_policy_version: z.literal("pdf_formula_glyph_policy.v1").optional(),
  asset_region_policy_version: z.literal("pdf_asset_region_policy.v1").optional(),
  binding_ownership_policy_version: z.literal("pdf_binding_ownership_policy.v1").optional(),
  book_id: z.string().min(1),
  coordinate_system: PdfCoordinateSystemZ,
  pages: z.array(PdfPageMetaZ),
...
export const AlignmentReportZ = z.object({
  ...
  book_id: z.string().min(1),
  config: z.object({
    algorithm: z.enum(["monotonic_forward_fuzzy_v1", "monotonic_windowed_blocks_v2", "monotonic_windowed_characters_v3", "banded_windowed_characters_v4"]),
